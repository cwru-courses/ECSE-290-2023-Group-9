...
public class CheckScript : MonoBehaviour
{
    ...
    {
        if (!drawing_1_Complete && Camera.main.transform.position.x > -300 && Camera.main.transform.position.x < -288)
        {
    ...
    public void CheckDrawing2()
    {
        ...
        if (!drawing_2_Complete && Camera.main.transform.position.x > -284 && Camera.main.transform.position.x < -275)
        {
    ...
    public void CheckDrawing3()
    {
        ...
        if (!drawing_3_Complete && Camera.main.transform.position.x > -272 && Camera.main.transform.position.x < -260)
        {
